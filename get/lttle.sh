...
VERSION="0.1.0-rc3"
DARWIN_URL="https://github.com/lttle-cloud/ignition/releases/download/v0.1.0-rc3/lttle_darwin_aarch64"
LINUX_URL="https://github.com/lttle-cloud/ignition/releases/download/v0.1.0-rc3/lttle_linux_x86_64"
...
say "• Downloading lttle v0.1.0-rc3 from: $TARGET_URL"
