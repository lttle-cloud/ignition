...
pub fn generate_version_struct(
    ...
    named.insert(
        0,
        syn::parse_quote!(#[serde(deserialize_with = "super::de_identifier")] name: String),
    );
    if args.namespaced {
        named.insert(
            0,
            syn::parse_quote!(#[serde(default, deserialize_with = "super::de_opt_identifier")] namespace: Option<String>),
        );
    }
